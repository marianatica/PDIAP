(function(){
	...
	.controller('rankingCtrl', function($scope, $rootScope, $mdDialog, $filter, avaliacaoAPI) {
		...
		$scope.reordenar = function(){		
			...
			var eixo6 = [];
			var eixo7 = [];
			$rootScope.eixo1_1 = $filter('orderBy')($rootScope.eixo1_1,'-total',false);
			$rootScope.eixo1_2 = $filter('orderBy')($rootScope.eixo1_2,'-total',false);
			$rootScope.eixo1_3 = $filter('orderBy')($rootScope.eixo1_3,'-total',false);
			$rootScope.eixo1_4 = $filter('orderBy')($rootScope.eixo1_4,'-total',false);

			$rootScope.eixo2_1 = $filter('orderBy')($rootScope.eixo2_1,'-total',false);
			$rootScope.eixo2_2 = $filter('orderBy')($rootScope.eixo2_2,'-total',false);
			$rootScope.eixo2_3 = $filter('orderBy')($rootScope.eixo2_3,'-total',false);
			$rootScope.eixo2_4 = $filter('orderBy')($rootScope.eixo2_4,'-total',false);

			$rootScope.eixo1 = $filter('orderBy')($rootScope.eixo1,'-total',false);
			$rootScope.eixo2 = $filter('orderBy')($rootScope.eixo2,'-total',false);
			$rootScope.eixo3 = $filter('orderBy')($rootScope.eixo3,'-total',false);
			$rootScope.eixo4 = $filter('orderBy')($rootScope.eixo4,'-total',false);
			$rootScope.eixo5 = $filter('orderBy')($rootScope.eixo5,'-total',false);
			$rootScope.eixo6 = $filter('orderBy')($rootScope.eixo6,'-total',false);
			$rootScope.eixo7 = $filter('orderBy')($rootScope.eixo7,'-total',false);
			for(var x=0; x<4;x++){
			...
			if(eixo1_1[3] == null) eixo1_1[3] = {_id:null,total:0};
			if(eixo1_2[3] == null) eixo1_2[3] = {_id:null,total:0};
			if(eixo1_3[3] == null) eixo1_3[3] = {_id:null,total:0};
			if(eixo1_4[3] == null) eixo1_4[3] = {_id:null,total:0};

			if(eixo2_1[3] == null) eixo1_1[3] = {_id:null,total:0};
			if(eixo2_2[3] == null) eixo1_2[3] = {_id:null,total:0};
			if(eixo2_3[3] == null) eixo1_3[3] = {_id:null,total:0};
			if(eixo2_4[3] == null) eixo1_4[3] = {_id:null,total:0};

			if(eixo1[3] == null) eixo1[3] = {_id:null,total:0};
			if(eixo2[3] == null) eixo2[3] = {_id:null,total:0};
			if(eixo3[3] == null) eixo3[3] = {_id:null,total:0};
			if(eixo4[3] == null) eixo4[3] = {_id:null,total:0};
			if(eixo5[3] == null) eixo5[3] = {_id:null,total:0};
			if(eixo6[3] == null) eixo6[3] = {_id:null,total:0};
			if(eixo7[3] == null) eixo7[3] = {_id:null,total:0};
			...
			$rootScope.eixo1_1 = $filter('orderBy')(eixo1_1,'nomeProjeto',false);
			$rootScope.eixo1_2 = $filter('orderBy')(eixo1_2,'nomeProjeto',false);
			$rootScope.eixo1_3 = $filter('orderBy')(eixo1_3,'nomeProjeto',false);
			$rootScope.eixo1_4 = $filter('orderBy')(eixo1_4,'nomeProjeto',false);

			$rootScope.eixo2_1 = $filter('orderBy')(eixo2_1,'nomeProjeto',false);
			$rootScope.eixo2_2 = $filter('orderBy')(eixo2_2,'nomeProjeto',false);
			$rootScope.eixo2_3 = $filter('orderBy')(eixo2_3,'nomeProjeto',false);
			$rootScope.eixo2_4 = $filter('orderBy')(eixo2_4,'nomeProjeto',false);

			$rootScope.eixo1 = $filter('orderBy')(eixo1,'nomeProjeto',false);
			$rootScope.eixo2 = $filter('orderBy')(eixo2,'nomeProjeto',false);
			$rootScope.eixo3 = $filter('orderBy')(eixo3,'nomeProjeto',false);
			$rootScope.eixo4 = $filter('orderBy')(eixo4,'nomeProjeto',false);
			$rootScope.eixo5 = $filter('orderBy')(eixo5,'nomeProjeto',false);
			$rootScope.eixo6 = $filter('orderBy')(eixo6,'nomeProjeto',false);
			$rootScope.eixo7 = $filter('orderBy')(eixo7,'nomeProjeto',false);
		}

		$scope.recarregar = function(filtro){
			$rootScope.eixo1_1 = $filter('orderBy')($rootScope.eixo1_1,filtro,false);
			$rootScope.eixo1_2 = $filter('orderBy')($rootScope.eixo1_2,filtro,false);
			$rootScope.eixo1_3 = $filter('orderBy')($rootScope.eixo1_3,filtro,false);
			$rootScope.eixo1_4 = $filter('orderBy')($rootScope.eixo1_4,filtro,false);

			$rootScope.eixo2_1 = $filter('orderBy')($rootScope.eixo2_1,filtro,false);
			$rootScope.eixo2_2 = $filter('orderBy')($rootScope.eixo2_2,filtro,false);
			$rootScope.eixo2_3 = $filter('orderBy')($rootScope.eixo2_3,filtro,false);
			$rootScope.eixo2_4 = $filter('orderBy')($rootScope.eixo2_4,filtro,false);

			$rootScope.eixo1 = $filter('orderBy')($rootScope.eixo1,filtro,false);
			$rootScope.eixo2 = $filter('orderBy')($rootScope.eixo2,filtro,false);
			$rootScope.eixo3 = $filter('orderBy')($rootScope.eixo3,filtro,false);
			$rootScope.eixo4 = $filter('orderBy')($rootScope.eixo4,filtro,false);
			$rootScope.eixo5 = $filter('orderBy')($rootScope.eixo5,filtro,false);
			$rootScope.eixo6 = $filter('orderBy')($rootScope.eixo6,filtro,false);
			$rootScope.eixo7 = $filter('orderBy')($rootScope.eixo7,filtro,false);
		}
